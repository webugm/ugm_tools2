...
if (!defined("_UGM_TOOLS_PATH")) {
	define("_UGM_TOOLS2_PATH", XOOPS_ROOT_PATH . "/modules/ugm_tools2");
}

if (!defined("_UGM_TOOLS_URL")) {
	define("_UGM_TOOLS2_URL", XOOPS_URL . "/modules/ugm_tools2");
}

global $xoopsConfig;
include_once _UGM_TOOLS_PATH . "/language/{$xoopsConfig['language']}/main.php";

//取得UgmTools的$UgmToolsXoopsModuleConfig
if (!function_exists('UgmTools2XoopsModuleConfig')) {
	function UgmTools2XoopsModuleConfig() {
		$modhandler = xoops_gethandler('module');
		$xoopsModule = $modhandler->getByDirname("ugm_tools");
